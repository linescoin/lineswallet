...
const char COMMUNITY_FORUM_URL[] = "https://lines.pw";
const char REPORT_ISSUE_URL[] = "https://lines.pw/";
...
MainWindow::MainWindow(ICryptoNoteAdapter* _cryptoNoteAdapter, IAddressBookManager* _addressBookManager,
  ...
  m_ui->setupUi(this);
  setWindowTitle(tr("Lines Wallet %1").arg(Settings::instance().getVersion()));
