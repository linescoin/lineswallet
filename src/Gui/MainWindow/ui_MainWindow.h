...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/lines"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        m_aboutLinesAction = new QAction(MainWindow);
        m_aboutLinesAction->setObjectName(QStringLiteral("m_aboutLinesAction"));
        m_aboutLinesAction->setEnabled(true);
        ...
        menuHelp->addAction(m_aboutLinesAction);
        ...
        QObject::connect(m_aboutLinesAction, SIGNAL(triggered()), MainWindow, SLOT(about()));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
...
#endif // QT_NO_TOOLTIP
        m_aboutLinesAction->setText(QApplication::translate("MainWindow", "About Lines", Q_NULLPTR));
        ...
        m_sendButton->setText(QApplication::translate("MainWindow", "SEND LINES", Q_NULLPTR));
