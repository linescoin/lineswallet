...
```
git clone https://github.com/linescoin/lineswallet.git
```
...
```
cp src/lineswallet.desktop build/
cp src/images/lines.png build/
cd build
linuxdeployqt.AppImage lineswallet.desktop -appimage -verbose=2 -always-overwrite -no-translations
```
